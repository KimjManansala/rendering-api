...
// GET /api/albums
app.get('/api/albums', (req, res, nextFn) => {
    res.send(albums)
})

// GET /api/circles
app.get('/api/circles', (req, res, nextFn) => {
    res.send(circles)
})

// GET /api/movies
app.get('/api/movies', (req, res, nextFn) => {
    res.send(movies)
})

// GET /api/nametags
app.get('/api/nametags', (req, res, nextFn) =>{
    res.send(nameTags)
})

// GET /api/poker

app.get('/api/poker', (req, res, nextFn) =>{
    res.send(poker)
})

// GET /api/rectangle
app.get('/api/rectangle', (req, res, nextFn) =>{
    res.send(rectangle)
})

// GET /api/restaurants
app.get('/api/restaurants', (req, res, nextFn) =>{
    res.send(restaurants)
})

// GET /api/students

app.get('/api/students', (req, res, nextFn) =>{
    res.send(students)
})
// GET /api/surveys
app.get('/api/surveys', (req, res, nextFn) =>{
    res.send(surveys)
})

// GET /api/tweets
app.get('/api/tweets', (req, res, nextFn) =>{
    res.send(tweets)
})
